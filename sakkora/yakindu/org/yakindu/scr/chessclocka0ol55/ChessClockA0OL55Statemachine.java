...
public class ChessClockA0OL55Statemachine implements IChessClockA0OL55Statemachine {
	...
	public enum State {
		t_Ready_to_play, t_White_initial_time, t_Black_Initial_time, t_Increment_time, t_Beginning_player, t_Beginning_player_Selection_White_begins, t_Beginning_player_Selection_Black_begins, t_Game, t_Game_In_progress_White_turn, t_Game_In_progress_Black_turn, t_Game_In_progress_White_fallen, t_Game_In_progress_Black_fallen, t_Game_In_progress_Black_adjourned, t_Game_In_progress_White_adjourned, $NullState$
	};
	...
	public void exit() {
		switch (stateVector[0]) {
			...
			case t_Game_In_progress_White_turn :
				nextStateIndex = 0;
				stateVector[0] = State.$NullState$;
			...
			case t_Game_In_progress_Black_turn :
				nextStateIndex = 0;
				stateVector[0] = State.$NullState$;
			...
			case t_Game_In_progress_White_fallen :
				nextStateIndex = 0;
				stateVector[0] = State.$NullState$;
				break;

			case t_Game_In_progress_Black_fallen :
				nextStateIndex = 0;
				stateVector[0] = State.$NullState$;
				break;

			case t_Game_In_progress_Black_adjourned :
				nextStateIndex = 0;
				stateVector[0] = State.$NullState$;
				break;

			case t_Game_In_progress_White_adjourned :
				nextStateIndex = 0;
				stateVector[0] = State.$NullState$;
				break;
		...
		switch (state) {
			...
			case t_Game :
				return stateVector[0].ordinal() >= State.t_Game.ordinal()
						&& stateVector[0].ordinal() <= State.t_Game_In_progress_White_adjourned.ordinal();
			case t_Game_In_progress_White_turn :
				return stateVector[0] == State.t_Game_In_progress_White_turn;
			case t_Game_In_progress_Black_turn :
				return stateVector[0] == State.t_Game_In_progress_Black_turn;
			case t_Game_In_progress_White_fallen :
				return stateVector[0] == State.t_Game_In_progress_White_fallen;
			case t_Game_In_progress_Black_fallen :
				return stateVector[0] == State.t_Game_In_progress_Black_fallen;
			case t_Game_In_progress_Black_adjourned :
				return stateVector[0] == State.t_Game_In_progress_Black_adjourned;
			case t_Game_In_progress_White_adjourned :
				return stateVector[0] == State.t_Game_In_progress_White_adjourned;
			default :
				return false;
		}
	}
	...
	*/
		...
		if (sCIButtons.modeButton) {
			...
			if (sCIButtons.startButton) {
				...
				if (whiteBegins) {
					...
					nextStateIndex = 0;
					stateVector[0] = State.t_Game_In_progress_White_turn;
				} else {
					sCIBeeper.operationCallback.beep();
					...
					nextStateIndex = 0;
					stateVector[0] = State.t_Game_In_progress_Black_turn;
				}
			}
		}
	}
	...
	private void reactT_Game_In_progress_White_turn() {
		if (sCIButtons.startButton) {
			switch (stateVector[0]) {
				case t_Game_In_progress_White_turn :
					nextStateIndex = 0;
			...
			if (timeEvents[0]) {
				...
				if (whiteTime > 0) {
					...
					nextStateIndex = 0;
					stateVector[0] = State.t_Game_In_progress_White_fallen;
				}
			} else {
				if (sCIButtons.whiteButton) {
					nextStateIndex = 0;
					...
					if (whiteTime + incrementTime <= 1200) {
						...
						if (whitePause) {
							...
							nextStateIndex = 0;
							stateVector[0] = State.t_Game_In_progress_White_adjourned;
						} else {
	...
	private void reactT_Game_In_progress_Black_turn() {
		if (sCIButtons.startButton) {
			switch (stateVector[0]) {
				case t_Game_In_progress_White_turn :
					nextStateIndex = 0;
			...
			if (timeEvents[1]) {
				...
				if (blackTime > 0) {
					...
					nextStateIndex = 0;
					stateVector[0] = State.t_Game_In_progress_Black_fallen;
				}
			} else {
				if (sCIButtons.blackButton) {
					nextStateIndex = 0;
					...
					if (blackTime + incrementTime <= 1200) {
						...
						if (blackPause) {
							...
							nextStateIndex = 0;
							stateVector[0] = State.t_Game_In_progress_Black_adjourned;
						} else {
	...
	private void reactT_Game_In_progress_White_fallen() {
		if (sCIButtons.startButton) {
			switch (stateVector[0]) {
				case t_Game_In_progress_White_turn :
					nextStateIndex = 0;
	...
	private void reactT_Game_In_progress_Black_fallen() {
		if (sCIButtons.startButton) {
			switch (stateVector[0]) {
				case t_Game_In_progress_White_turn :
					nextStateIndex = 0;
	...
	private void reactT_Game_In_progress_Black_adjourned() {
		if (sCIButtons.startButton) {
			switch (stateVector[0]) {
				case t_Game_In_progress_White_turn :
					nextStateIndex = 0;
	...
	private void reactT_Game_In_progress_White_adjourned() {
		if (sCIButtons.startButton) {
			switch (stateVector[0]) {
				case t_Game_In_progress_White_turn :
					nextStateIndex = 0;
		...
		for (nextStateIndex = 0; nextStateIndex < stateVector.length; nextStateIndex++) {
			...
			switch (stateVector[nextStateIndex]) {
				...
				case t_Beginning_player_Selection_Black_begins :
					...
					break;
				case t_Game_In_progress_White_turn :
					reactT_Game_In_progress_White_turn();
					break;
				case t_Game_In_progress_Black_turn :
					reactT_Game_In_progress_Black_turn();
					break;
				case t_Game_In_progress_White_fallen :
					reactT_Game_In_progress_White_fallen();
					break;
				case t_Game_In_progress_Black_fallen :
					reactT_Game_In_progress_Black_fallen();
					break;
				case t_Game_In_progress_Black_adjourned :
					reactT_Game_In_progress_Black_adjourned();
					break;
				case t_Game_In_progress_White_adjourned :
					reactT_Game_In_progress_White_adjourned();
					break;
				default :
					// $NullState$
			}
