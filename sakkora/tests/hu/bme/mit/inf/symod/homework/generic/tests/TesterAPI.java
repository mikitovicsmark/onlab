...
public class TesterAPI {
	...
	protected void insertCheck(String check, boolean correct, String expected, String result) {
		if(correct) {
			...
			Assert.fail(name + " failed by "+error);
		}
		checkNumber++;
	}
